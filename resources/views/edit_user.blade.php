...
<head>
    ...
    <title>Maressia - Edit User</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('user.update', $user['id']) }}}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="npm" name="npm" class="form-control" value="{{ old('nama', $user->nama) }}">
                                    <p class="text-red-500 text-xs mt-1 text-left">{{$msg}}</p>
                                @endforeach
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                @if($user->foto)
                                    <img src="{{ asset($user->foto) }}" alt="User Photo" class="card-img-top" alt="">
                                @endif
                            </div>
